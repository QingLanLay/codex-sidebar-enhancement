# Codex 侧栏增强 0.4.28 · 当前测试版 / Codex Sidebar Enhancement 0.4.28 Preview
...
1. The package targets Windows Codex **26.917.9434.0** and Node.js **22 or later**. Compatibility is checked before installation.
