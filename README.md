...
A Windows desktop enhancement for Codex, adding a sidebar, session quick bar, conversation history, and settings panel. Current distribution version: **0.4.27**.
...
- [Windows 安装包（支持符合条件的热更新） | Windows installer (hot update when supported)](exports/Codex侧栏增强-0.4.27-Windows.zip)
- [交给其他 Codex 的一键安装说明 | One-click installation instructions for another Codex](exports/Codex侧栏增强-0.4.27/交给其他Codex一键安装.md)
...
- `exports/Codex侧栏增强-0.4.27/`：当前发行版文件、SHA-256 清单和安装/卸载脚本 | Current distribution files, SHA-256 manifest, and install/uninstall scripts.
- `exports/Codex侧栏增强-0.4.27-Windows.zip`：可分发安装包 | Distributable Windows package.
